...
type PubSubClient interface {
	...
	ManagedSubscribe(ctx context.Context, opts ...grpc.CallOption) (PubSub_ManagedSubscribeClient, error)
}
...
func (c *pubSubClient) PublishStream(ctx context.Context, opts ...grpc.CallOption) (PubSub_PublishStreamClient, error) {
	...
	x := &pubSubPublishStreamClient{ClientStream: stream}
	return x, nil
}
...
func (c *pubSubClient) ManagedSubscribe(ctx context.Context, opts ...grpc.CallOption) (PubSub_ManagedSubscribeClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &PubSub_ServiceDesc.Streams[2], PubSub_ManagedSubscribe_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &pubSubManagedSubscribeClient{ClientStream: stream}
	return x, nil
}

type PubSub_ManagedSubscribeClient interface {
	Send(*ManagedFetchRequest) error
	Recv() (*ManagedFetchResponse, error)
	grpc.ClientStream
}

type pubSubManagedSubscribeClient struct {
	grpc.ClientStream
}

func (x *pubSubManagedSubscribeClient) Send(m *ManagedFetchRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *pubSubManagedSubscribeClient) Recv() (*ManagedFetchResponse, error) {
	m := new(ManagedFetchResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type PubSubServer interface {
	...
	// Same as Subscribe, but for Managed Subscription clients.
	// This feature is part of an open beta release.
	ManagedSubscribe(PubSub_ManagedSubscribeServer) error
...
func (UnimplementedPubSubServer) ManagedSubscribe(PubSub_ManagedSubscribeServer) error {
	return status.Errorf(codes.Unimplemented, "method ManagedSubscribe not implemented")
}
...
func _PubSub_Subscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(PubSubServer).Subscribe(&pubSubSubscribeServer{ServerStream: stream})
}
...
func _PubSub_PublishStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(PubSubServer).PublishStream(&pubSubPublishStreamServer{ServerStream: stream})
}
...
func _PubSub_ManagedSubscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(PubSubServer).ManagedSubscribe(&pubSubManagedSubscribeServer{ServerStream: stream})
}

type PubSub_ManagedSubscribeServer interface {
	Send(*ManagedFetchResponse) error
	Recv() (*ManagedFetchRequest, error)
	grpc.ServerStream
}

type pubSubManagedSubscribeServer struct {
	grpc.ServerStream
}

func (x *pubSubManagedSubscribeServer) Send(m *ManagedFetchResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *pubSubManagedSubscribeServer) Recv() (*ManagedFetchRequest, error) {
	m := new(ManagedFetchRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
var PubSub_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "eventbus/v1/pubsub_api.proto",
}
