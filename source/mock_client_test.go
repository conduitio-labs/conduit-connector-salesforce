...
import (
	...
	position "github.com/conduitio-labs/conduit-connector-salesforce/source/position"
...
func (_c *mockClient_Initialize_Call) Run(run func(_a0 context.Context, _a1 []string)) *mockClient_Initialize_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *mockClient_Initialize_Call) RunAndReturn(run func(context.Context, []string) error) *mockClient_Initialize_Call {
	_c.Call.Return(run)
	return _c
}

// Next provides a mock function with given fields: _a0
func (_m *mockClient) Next(_a0 context.Context) (opencdc.Record, error) {
	ret := _m.Called(_a0)
...
func (_c *mockClient_Next_Call) Return(_a0 opencdc.Record, _a1 error) *mockClient_Next_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockClient_Next_Call) RunAndReturn(run func(context.Context) (opencdc.Record, error)) *mockClient_Next_Call {
	_c.Call.Return(run)
	return _c
}

// StartCDC provides a mock function with given fields: _a0, _a1, _a2, _a3, _a4
func (_m *mockClient) StartCDC(_a0 context.Context, _a1 string, _a2 position.Topics, _a3 []string, _a4 time.Duration) error {
	ret := _m.Called(_a0, _a1, _a2, _a3, _a4)

	if len(ret) == 0 {
		panic("no return value specified for StartCDC")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, position.Topics, []string, time.Duration) error); ok {
...
// mockClient_StartCDC_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StartCDC'
type mockClient_StartCDC_Call struct {
	*mock.Call
}

// StartCDC is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 string
//   - _a2 position.Topics
//   - _a3 []string
//   - _a4 time.Duration
func (_e *mockClient_Expecter) StartCDC(_a0 interface{}, _a1 interface{}, _a2 interface{}, _a3 interface{}, _a4 interface{}) *mockClient_StartCDC_Call {
	return &mockClient_StartCDC_Call{Call: _e.mock.On("StartCDC", _a0, _a1, _a2, _a3, _a4)}
}

func (_c *mockClient_StartCDC_Call) Run(run func(_a0 context.Context, _a1 string, _a2 position.Topics, _a3 []string, _a4 time.Duration)) *mockClient_StartCDC_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(position.Topics), args[3].([]string), args[4].(time.Duration))
	})
	return _c
}

func (_c *mockClient_StartCDC_Call) Return(_a0 error) *mockClient_StartCDC_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *mockClient_StartCDC_Call) RunAndReturn(run func(context.Context, string, position.Topics, []string, time.Duration) error) *mockClient_StartCDC_Call {
	_c.Call.Return(run)
	return _c
}
