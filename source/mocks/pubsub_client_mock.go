...
func (_m *PubSubClient) ManagedSubscribe(ctx context.Context, opts ...grpc.CallOption) (proto.PubSub_ManagedSubscribeClient, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 proto.PubSub_ManagedSubscribeClient
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...grpc.CallOption) (proto.PubSub_ManagedSubscribeClient, error)); ok {
		return rf(ctx, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ...grpc.CallOption) proto.PubSub_ManagedSubscribeClient); ok {
		r0 = rf(ctx, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(proto.PubSub_ManagedSubscribeClient)
		}
	}
...
// PubSubClient_ManagedSubscribe_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ManagedSubscribe'
type PubSubClient_ManagedSubscribe_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - opts ...grpc.CallOption
func (_e *PubSubClient_Expecter) ManagedSubscribe(ctx interface{}, opts ...interface{}) *PubSubClient_ManagedSubscribe_Call {
	return &PubSubClient_ManagedSubscribe_Call{Call: _e.mock.On("ManagedSubscribe",
		append([]interface{}{ctx}, opts...)...)}
}

func (_c *PubSubClient_ManagedSubscribe_Call) Run(run func(ctx context.Context, opts ...grpc.CallOption)) *PubSubClient_ManagedSubscribe_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *PubSubClient_ManagedSubscribe_Call) Return(_a0 proto.PubSub_ManagedSubscribeClient, _a1 error) *PubSubClient_ManagedSubscribe_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *PubSubClient_ManagedSubscribe_Call) RunAndReturn(run func(context.Context, ...grpc.CallOption) (proto.PubSub_ManagedSubscribeClient, error)) *PubSubClient_ManagedSubscribe_Call {
	_c.Call.Return(run)
	return _c
}
